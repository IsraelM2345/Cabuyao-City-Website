            ...
            <div className="max-w-6xl mx-auto px-6 py-16 lg:py-24">
                <div className="rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row relative bg-white border border-gray-100">
                    ...
                    <div className="md:w-7/12 p-10 md:p-16 flex flex-col justify-center bg-white">
                        <span className="bg-red-50 text-red-600 text-xs font-bold px-4 py-1.5 rounded-full w-fit mb-4 shadow-sm border border-red-100 uppercase tracking-wide">
                        ...
                        <div className="space-y-4 text-gray-600 leading-relaxed mb-8">
                            <p>
                                Welcome to the official portal of the City
                                Government of Cabuyao. As your Local Chief
                                Executive, it is my sworn duty to ensure that
                                the city's progress benefits every sector of our
                                community.
                            </p>
                            <p>
                                My administration stands firmly on the principle
                                of{" "}
                                <strong>
                                    "Pera ng Bayan, Ibalik sa Mamamayan."
                                </strong>{" "}
                                We believe that every peso collected from the
                                people must be returned to them through
                                excellent public service, modern infrastructure,
                                comprehensive healthcare, and quality education.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-100">
                            <a
                                ...
                                className="bg-[#0f4a96] hover:bg-[#0c3975] text-white px-6 py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition w-full sm:w-auto shadow-md"
                            >
                                <MessageCircle size={18} /> Official Facebook
                                Page
                            </a>
                            <a
                                href="mailto:mayor@cabuyao.gov.ph"
                                className="bg-gray-100 hover:bg-gray-200 text-gray-800 border border-gray-200 px-6 py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition w-full sm:w-auto"
                            >
                                <Mail size={18} /> Email the Mayor
                            </a>
                        </div>
                    </div>
                </div>
