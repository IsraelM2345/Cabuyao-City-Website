...
const NAV_ITEMS = [
    ...
    { icon: Users, label: "Evacuee Profiles", href: "/evacuee-profiles" },
    {
        icon: Package,
    ...
    { icon: FileBarChart, label: "System Reports", href: "/system-reports" },
...
export function Sidebar({ currentPage = "Dashboard" }) {
    ...
    return (
        <>
            ...
            <div
                // CHANGED: z-40 to z-20 so it sits below modals
            ...
            >
                ...
                <div className="px-2 py-4 border-t border-gray-100 dark:border-gray-800 space-y-0.5 transition-colors">
                    <button
                        type="button"
                        onClick={() => setShowLogoutModal(true)}
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 w-full transition-all group"
                    >
                        <LogOut
                            size={18}
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800/50 w-full transition-all"
                    >
                        <ChevronLeft
                            size={18}
...
export function TopBar({ title, subtitle }) {
    ...
    return (
        <div className="flex items-center justify-between px-6 py-4 border-b transition-colors bg-white border-gray-100 dark:bg-gray-900 dark:border-gray-800 z-10 relative">
            {/* CHANGED: z-30 to z-10 so it sits below modals */}
            <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={notificationRef}>
                    <button
                        ...
                        className={`p-2 rounded-lg transition relative ${showNotifications ? "bg-gray-100 dark:bg-gray-800 text-teal-600 dark:text-teal-400" : "hover:bg-gray-100 text-gray-500 dark:hover:bg-gray-800 dark:text-gray-300"}`}
                    >
                        <Bell size={18} />
                        {unreadCount > 0 && (
                            ...
                            <div className="max-h-[320px] overflow-y-auto">
                                {notifications.length === 0 ? (
                                    ...
                                    notifications.map((n) => (
                                        <div
                                            key={n.id}
                                            className={`p-4 border-b border-gray-50 dark:border-gray-700/50 flex gap-3 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/30 ${n.unread ? "bg-teal-50/30 dark:bg-teal-900/10" : ""}`}
                                        >
                                            ...
                                            <div className="flex-1">
                                                <p
                                                    className={`text-sm mb-0.5 ${n.unread ? "font-semibold text-gray-900 dark:text-gray-100" : "font-medium text-gray-700 dark:text-gray-300"}`}
                                                >
                                                    {n.title}
                                                </p>
    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-gray-950 font-sans overflow-hidden transition-colors">
            ...
            <div className="flex-1 flex flex-col overflow-hidden relative">
                ...
                {/* CHANGED: Removed "relative z-0" so modals can escape the main container */}
